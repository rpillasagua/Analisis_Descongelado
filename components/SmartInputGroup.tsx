    ...
    return (
        <div className="space-y-2">
            ...
            <div className="relative flex items-center">
              ...
              ${photoUrl ? 'bg-blue-50 text-blue-600 hover:bg-blue-100 border border-blue-200' : 'bg-gray-100 text-gray-500 hover:bg-gray-200 hover:text-gray-700'}
                ...
                >
                    <div className="relative w-full max-w-lg bg-black rounded-2xl overflow-hidden shadow-2xl border border-white/10">
                        ...
                        <div className="relative w-full aspect-[3/4] sm:aspect-square bg-zinc-900">
                            <img src={photoUrl} alt={label} className="object-contain w-full h-full" />
                        </div>
